  ...
  <form action="bocadillo.php" method="post">
   ...
   <legend>Datos personales y envío</legend>
     ...
     <fieldset>
        ...
        <div><input id="recoger_en_local" type="radio" name="entrega" checked="checked" value="Listo para recoger en local"/><label for="recoger_en_local">Recoger en el local </label></div>
        <div><input id="envio_a_domicilio" type="radio" name="entrega" value="De camino al destino"/><label for="envio_a_domicilio">Envío a domicilio</label></div>
